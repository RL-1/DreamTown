...
let state = {
    ...
    FooterAdressItem:[
        ...
        {
            text:'Киев, Оболонский просп., 1-б\n(метро Оболонь, Минская)\n067 541 60 09 инфо справка'
        },
        {
            text:'2 часть'
        },
        {
            text:'Киев, Оболонский просп., 21-б\n(метро Минская, Героев Днепра)\n067 541 59 27 инфо справка'
        },
        {
            text:'ПАРКИНГ'
        },
        {
            text:'Режим роботи - круглосуточно\nОболонский пр., 1-б (со стороны ст.метро Оболонь)\n095 563 88 44\n097 563 88 44'
        },
    ]
